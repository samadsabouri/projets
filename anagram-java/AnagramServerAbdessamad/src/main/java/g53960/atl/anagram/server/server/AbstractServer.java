 ...
 * <ul>
 * <li> An instance variable refering to the current connection factory. Refer
 * to null value by default, in this case regular
 * <code>ConnectionToClient</code> instances are created as in the previous
 * versions.
...
public abstract class AbstractServer extends Observable implements Runnable {
    ...
    /**
     * The thread group associated with client threads. Each user of the thread
...
//                                    this.clientThreadGroup, clientSocket, this);
                            new ConnectionToClient(
                                    this.threads, clientSocket, this);
                        }
