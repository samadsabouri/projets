...
class Words {
     ...
     * @throws g53960.atl.anagram.server.exception.ModelException if the container is closed.
     */
     ...
     * Shuffles the words.
     *
     * @throws g53960.atl.anagram.server.exception.ModelException if the list is not closed.
     */
     ...
     *
     * @throws g53960.atl.anagram.server.exception.ModelException if the container is not closed.
     */
